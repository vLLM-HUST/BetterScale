...
Fletcher retired AE separation on 2026-09-24. Do not resume its experiments or
merge its `expert_service` MOD into product main as routine continuation.
The complete prototype, MOD and event-client branches are preserved in
[the personal research fork](https://github.com/CubeLander/BetterScale/tree/archive/ae-final).
The historical AE knowledge formerly following this heading is preserved
[at the exact pre-retirement revision](https://github.com/CubeLander/BetterScale/blob/d5ccbd5201cd8878ced155978bff39712d8ff0df/.agents/skills/repo-knowledge/scenarios/extend-dsv4-full-graph/GUIDE.md#split-qwen-attention-around-an-asynchronous-expert-boundary).

`prototypes/attention-client/README.md` is now a recovery pointer, not a runnable
implementation. Shared admission moved byte-for-byte to
`prototypes/host-admission/admit_subset.py`; six non-AE launchers follow it.
Native joint-wave/owned-wave, TP/EP and MTP work remain separate and maintained.

...
READY前完成有限producer/metadata目录；缺失形状走原生回退，不在线capture。
TP组合不变。发布归档沿用已验收DP预热实现的+39.63%及TP的+35.17%，
不是新的wheel硬件测量；55项CPU测试和安装检查是本轮新增证据。
[全部端到端轮次与版本来源](E2E-20260914.zh-CN.md)。

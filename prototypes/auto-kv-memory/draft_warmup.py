"""Experimental TP DSpark preparation through its native proposer, before READY.

No scheduler requests are admitted here. Seed only unused KV pages; the trial
cache is subsequently retired. Final-cache preparation needs separate replay
and State-lifetime qualification before this can become a released startup hook.
"""

...
cp "$src/"{persistent_vector.cpp,persistent_cube.cpp,persistent_protocol.hpp,priority_policy.hpp,streaming_gmm.hpp,actual_gmm.cpp,launch.cpp} "$OUTPUT_DIR/source/"
...
printf '%s\n' '{"server_config_words":27,"client_config_words":16,"hidden":2048,"inner":512,"topk":10,"owners":4}' > "$OUTPUT_DIR/abi.json"

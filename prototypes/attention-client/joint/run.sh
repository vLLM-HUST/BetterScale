...
capsule="$repo/runs/attention-joint-$stamp"
mkdir -p "$capsule/source/joint"
...
export PYTHONPATH="$capsule/source/joint:$capsule/source${PYTHONPATH:+:$PYTHONPATH}" PYTHONDONTWRITEBYTECODE=1

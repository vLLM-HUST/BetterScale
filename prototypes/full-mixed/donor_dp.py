...
def rank_main(args,dp_rank,barrier):
    ...
    config=dict(model=os.environ['PROBE_MODEL'],load_format='auto' if args.real else 'dummy',
                ...
                worker_extension_cls='donor_dp_worker.DonorDPWorker',
    ...
    if args.real:
        ...
        wave('dummyskew',[512 if dp_rank==0 else 32]*(8//args.donor_dp),16)
...
def main(args):
    ...
    assert args.donor_dp*args.tp==8 and args.donor_dp in (1,2,4,8)

"""Prototype wave-metadata MC2 vs current split candidate; same-pair ABBA."""
    ...
    try:
        for index, arm in enumerate(("split", "mc2", "mc2", "split")):
            ...
            env.update(ASCEND_RT_VISIBLE_DEVICES="6,7", COMPARE_NO_MTP="candidate",
                       ELASTIC_CANDIDATE="1", TASK_QUEUE_ENABLE="0", STEP_PREFILL_DELTA="1", STEP_MC2_QUALIFY="1",
                       PROBE_MC2_ROWS=str(int(arm == "mc2")),

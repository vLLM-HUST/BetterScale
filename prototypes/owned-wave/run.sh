...
cp "$repo/prototypes/owned-wave/"*.py "$PROBE_CAPSULE/source/"
...
export VLLM_HOST_IP=127.0.0.1 MASTER_ADDR=127.0.0.1 MASTER_PORT=31941
export HCCL_NPU_SOCKET_PORT_RANGE=29300-29363 VLLM_ASCEND_ENABLE_FLASHCOMM1=0
...
export OWNED_OUTPUT="$PROBE_CAPSULE/engine"
mkdir "$OWNED_OUTPUT"
